import{i as r}from"./gql-BaNKjVED.js";import{j as d}from"./jsx-runtime-DmS2nb87.js";r(`
...
`),t={all:["proposals"],lists:()=>[...t.all,"list"],list:e=>[...t.lists(),{filters:e}],paginated:(e,s)=>[...t.lists(),"paginated",{where:e,year:s}],details:()=>[...t.all,"detail"],detail:e=>[...t.details(),e],years:()=>[...t.all,"years"]},h={all:["proposals"],lists:()=>[...t.all,"list"],list:e=>[...t.lists(),{filters:e}],paginated:(e,s,n,o,l)=>[...t.lists(),"paginated",{page:e,pageSize:s,sort:n,where:o,year:l}],details:()=>[...t.all,"detail"],detail:e=>[...t.details(),e],years:()=>[...t.all,"years"]},S=r(`
...
`),i={all:["budgetYear"],list:(e=0,s=1)=>[...i.all,"list",{skip:e,take:s}],latest:()=>[...i.all,"latest"],years:()=>[...i.all,"years"]},G=r(`
...
`),m="/congress-budget-watch-platform/".replace(/\/$/,""),u=`${m}/`,I=500,y=/^([a-z][a-z\d+\-.]*:)?\/\//i,$=({src:e,...s})=>{const o=y.test(e)?e:`${u}${e.startsWith("/")?e.slice(1):e}`;return d.jsx("img",{src:o,...s})};export{S as G,$ as I,I as S,T as U,E as a,h as b,A as c,b as d,i as e,u as f,R as g,G as h,P as i,a as j,_ as k,p as l,t as p};
